// buttons
var sliderControl = document.querySelector(".prev-next");

// slides informations
var slides = document.querySelectorAll(".single-main"),
...
sliderControl.addEventListener("click", function(e){
  ...
  if(target.classList.contains("next")){
    ...
    slide.classList.add("single-main");
    slide.classList.remove("single-main");
    nextSlide.classList.add("single-main");
